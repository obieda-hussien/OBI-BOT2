...
// تأكد من أن هذا الكود يعمل عند بداية تشغيل البوت

// ضعه في أعلى ملفك الرئيسي قبل أي شيء

if (!global.conns) {

    global.conns = new Map(); // استخدم Map بدلاً من Array للبحث السريع بالرقم
